export const invitationEmailTemplate = ({ email, inviteLink }) => {
          ...
          <tr style="width: 100%">
            <td>
              ...
              <h1
                ...
                "
              >
                Join <strong>Honey Meadows</strong>
              </h1>
              <p style="font-size: 14px; line-height: 24px; margin: 16px 0; color: rgb(0, 0, 0)">
                ...
                >
                and come see what all the buzz is about. Click the following link to complete your urban
                hive sign up process. (JOIN BUTTON)
              </p>
              <table
                align="center"
                width="100%"
                  ...
                  <tr>
                    <td>
                      <a
                        ...
                        ><span
                          ><!--[if mso
                            ]><i style="letter-spacing: 80px; mso-font-width: -100%" hidden>&nbsp;</i><!
                          [endif]--></span
                        ></a
                      >
                    </td>
              ...
              <p style="font-size: 12px; line-height: 24px; margin: 16px 0; color: rgb(102, 102, 102)">
                This invitation was intended for <span style="color: rgb(0, 0, 0)">${email} </span>.This
                invite was sent from
                <span style="color: rgb(0, 0, 0)">Honey Meadows Farm Inc.</span> located in
                <span style="color: rgb(0, 0, 0)">CANADA</span>. If you were not expecting this invitation,
