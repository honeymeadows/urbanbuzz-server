                ...
                <tr>
                  <td>
                    ...
                    <h1
                      ...
                      "
                    >
                      ${project?.nickName?.client} Project Has a New Update
                    </h1>
                    <p
                      style="
                        margin-bottom: 0px;
                    ...
                    >
                      <a
                        ...
                        >Log in</a
                      >
                      to our app to view the full update and provide feedback.
                    </p>
                  </td>
                </tr>
              </tbody>
                ...
                <tr>
                  <td>
                    <p
                      ...
                      "
                    >
                      Posted on ${dayjs(new Date(update?.created)).format("MMM DD, YYYY H:MM A")}
                    </p>
                    <p
                      style="
                        margin-top: 0px;
