export const adminInvitation = ({ email, inviteLink }) => {
        ...
        <tr style="width: 100%">
          <td>
            ...
            <p style="font-size: 14px; line-height: 24px; margin: 16px 0; color: rgb(0, 0, 0)">
              A Honey Meadows admin has invited you to manage the
              <a
              ...
              >
              platform. click the following button to complete your sign up process.
            </p>
            <table
              align="center"
              width="100%"
